...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-center custom__pagination">

    <div class="flex justify-center flex-1 sm:hidden custom__pagination">
    ...
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between custom__pagination">
